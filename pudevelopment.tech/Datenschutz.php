...
<html lang="de">
    ...
    <body>
        ...
        <main>
            ...
            <p></p>
            <div data-exp="simple2" class="outputVersion1 template_DE templated">
				<div style="background:url('//www.rechtsdokumente.de/common/images/draft-de.jpg') repeat-y center top/contain #fff;"><div class=" header">
                    <span class="content">Datenschutzerklärung</span></div><div class=" footer">
                    <span class="pageNumbers">Seite <span class="currentPageNum"></span> von <span class="totalPageNum"></span></span></div><div class=" firstHeader">
                    <span class="content">Datenschutzerklärung</span></div><div class=" firstFooter">
