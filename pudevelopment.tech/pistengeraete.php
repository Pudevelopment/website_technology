            ...
            <main>
                ...
                <div class="gondel">
                    <?php   if ($_SERVER['REQUEST_METHOD'] === 'POST'){
                        ...
                        echo '
                        <iframe id="ytplayer" type="text/html" width="2000vh" height="1069vh"src="https://www.youtube.com/embed/sdC9WXNNEKo?autoplay=1&controls=0&disablekb=1&fs=0&loop=1&modestbranding=1&playlist=sdC9WXNNEKo&mute=1"frameborder="0" allowfullscreen></iframe>';
                    } 
                    ?>
                </div>
            </main> 
